...
function BarChartPanelAdapter(props: Props) {
...
BarChartPanelAdapter.panelType = "BarChart";
BarChartPanelAdapter.defaultConfig = {};

export default Panel(BarChartPanelAdapter);
